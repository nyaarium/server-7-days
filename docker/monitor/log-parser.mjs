...
const regexServerReady = /\[Steamworks\.NET\] Making server public/g;
const regexPlayerConnected = /NET: LiteNetLib: Connect from/g;
const regexPlayerDisconnected = /NET: LiteNetLib: Client disconnect/g;

/**
 * Fixes date format from 7 Days to Die server logs
